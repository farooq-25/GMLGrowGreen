    ...
    <footer className="footer-main">
      <div className="footer-main-container">
        ...
        <div className="footer-logo-section">
          <img src={logo} alt="GML Grow Green" className="footer-logo" />
          <p className="footer-tagline">Growing Green, Naturally</p>
          {/* Mobile Social Icons */}
          <div className="footer-social-icons mobile-only">
        ...
        <div className="footer-section">
          ...
          <div className={`footer-section-content ${openSections.contact ? 'open' : ''}`}>
            <div className="footer-contact-info">
              <div className="footer-contact-item">
                <MapPin className="footer-contact-icon" size={18} />
                <div className="footer-contact-text">
                  <p>#45, TM Abdul Hameed 5th Street,</p>
                  <p>Shakirabad, Vaniyambadi,</p>
                  <p>Tamil Nadu. Pincode : 635751</p>
                </div>
              </div>
        ...
        <div className="footer-section">
          ...
          <div className={`footer-section-content ${openSections.links ? 'open' : ''}`}>
      ...
      <div className="footer-bottom-section">
        <div className="footer-bottom-container">
          <p>&copy; 2024 GML Grow Green. All rights reserved.</p>
