  ...
  const processes = [
    {
      ...
      description:
        "Premium, breathable materials chosen for optimal root health and superior aeration",
    ...
    },
    {
      ...
      description:
        "Expertly designed using advanced techniques for sturdy, reliable products",
    ...
    },
    {
      ...
      description:
        "Commitment to organic, eco-friendly materials to minimize environmental impact",
    ...
    },
    {
      ...
      description:
        "Stringent inspections ensure every product meets our high standards",
    ...
    },
    {
      ...
      description:
        "Reliable logistics partners ensure prompt and secure shipping nationwide",
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <FadeInUp delay={0.5}>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed font-medium">
              Pioneering sustainable gardening solutions through innovation,
          ...
          <FadeInUp delay={0.2}>
            ...
            >
              <p className="text-lg md:text-xl text-gray-700 text-center leading-relaxed font-light">
                To provide premium organic grow bags that create the ideal
                environment for plant growth while significantly reducing
                environmental impact through sustainable practices and
                innovative design.
              </p>
            </motion.div>
          </FadeInUp>
                    ...
                    {[
                      {
                        ...
                        desc: "Superior materials for optimal growth",
                      },
                      {
                        icon: FaRecycle,
                        title: "Eco-Friendly",
                      ...
                      },
                      {
                        ...
                        desc: "Gardening guidance & assistance",
                      },
                    ].map((item, index) => (
                      <motion.div
                        key={index}
          ...
          <FadeInUp>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                From material selection to your doorstep, we maintain excellence
                at every step
              </p>
          ...
          <GrowUpCard>
            ...
            >
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                Discover exceptional quality and unbeatable value with our
